...
class SoundRecorder implements SlotEntry {
  ...
  void _onRecorderReady({bool result = false}) {
  ...
  Future<void> record(
    ...
    _initializeAndRun(() async {
      ...
      if (_recordingTrack!.track.mediaFormat == null ||
          !await NativeMediaFormats()
  ...
  Future<void> stop() async {
    ...
    await _initializeAndRun(() async {
      ...
      _dispositionManager!
          .updateDisposition(_dispositionManager!.lastDuration, 0);
